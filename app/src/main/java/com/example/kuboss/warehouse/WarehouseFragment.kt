...
class WarehouseFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val btnAdd: FloatingActionButton =
            binding.expandableFabLayoutHome.findViewById(R.id.add_rack_btn)
        btnAdd.setOnClickListener {
            findNavController().navigate(R.id.action_warehouseFragment_to_addRackFragment)
        }

        val btnReceive: FloatingActionButton =
            binding.expandableFabLayoutHome.findViewById(R.id.receive_mat_btn)
        btnReceive.setOnClickListener {
            findNavController().navigate(R.id.action_warehouseFragment_to_receiveMatFragment)
        }
        val btnMap: FloatingActionButton =
            binding.expandableFabLayoutHome.findViewById(R.id.view_map_btn)
        btnMap.setOnClickListener {
            findNavController().navigate(R.id.action_warehouseFragment_to_warehouseMapFragment)
        }
        val btnReport: FloatingActionButton =
            binding.expandableFabLayoutHome.findViewById(R.id.generate_report_btn)
